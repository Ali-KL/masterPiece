	...
	<div class="container">
			<div class="w3-agileits-team-title"> 
				...
				<ul class="col-md-6 col-sm-6 resp-tabs-list">
					<li>
						<img src="{{asset('mainTemplate/images/t1.jpg')}}" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="{{asset('mainTemplate/images/t2.jpg')}}" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="{{asset('mainTemplate/images/t3.jpg')}}" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="{{asset('mainTemplate/images/t4.jpg')}}" alt=" " class="img-responsive" />
					</li>
				</ul>
					<div class="tab1">
